...
class NLEMapLanguageWrapper(language_wrapper.NLELanguageWrapper):
    def __init__(self, env, vlm=False, skip_more=False, prompt_mode="map"):
    ...
    def get_text_action(self, action):
        return NLEMapLanguageWrapper.all_nle_action_map[self.env.actions[action]][0]
    ...
    def nle_obsv_type(self, nle_obsv):
        ...
        elif self.prompt_mode == "map":
            return self.render_map(nle_obsv)
        else:
    ...
    def create_action_space(self):
        if "minihack" in self.env.spec.id.lower():
            ...
            for action in self.env.actions:
                action_key = NLEMapLanguageWrapper.all_nle_action_map[action][0]
            ...
            available_actions = [
                action_strs[0]
                for action, action_strs in NLEMapLanguageWrapper.all_nle_action_map.items()
    ...
    def render_map(self, nle_obsv):
        ...
        long_term_context = nle_obsv['text_message'] + '\n' + nle_obsv['map']
        short_term_context = ''
